<script lang="ts">
    ...
    const dispatch =
        createEventDispatcher<{ open: undefined; close: string | undefined }>()
...
{#if isOpen}
    <section
        class="overlay"
        use:portal={'#windows-area'}
        use:elevation={'system-dialog'}
    >
        <div
            class="dialog"
...
<style lang="scss">
    ...
    .dialog {
        --elevation: 0px 2.7px 10.4px rgba(0, 0, 0, 0.124),
            0px 6.5px 25px rgba(0, 0, 0, 0.178),
            0px 12.3px 47.1px rgba(0, 0, 0, 0.22),
            0px 21.9px 84px rgba(0, 0, 0, 0.262),
            0px 40.9px 157.1px rgba(0, 0, 0, 0.316),
            0px 98px 376px rgba(0, 0, 0, 0.44);
        padding: 1rem;
