<script lang="ts">
    import {
        WallpaperID,
        wallpapersConfig,
    } from '__/configs/wallpapers/wallpaper.config'
...
<section class="container">
    ...
    <section class="main-area">
        <section class="selected-wallpaper-section">
            <div
                class="image"
                style="background-image: url(/wallpapers/{wallpapersConfig[
                    $wallpaper.id
                ].thumbnail}.jpg);"
            />
            <div class="info">
                ...
                <p class="wallpaper-type">
                    {wallpapersConfig[$wallpaper.id].type} wallpaper
                </p>
                <br /> <br />
                {#if wallpapersConfig[$wallpaper.id].type !== 'standalone'}
                    <label>
                        <input
                            type="checkbox"
                            bind:checked={$wallpaper.canControlTheme}
                        />
            ...
            &:focus-visible {
                img {
                    box-shadow: 0 0 0 0.25rem
                        hsla(var(--system-color-primary-hsl), 0.7);
                }
            }
        }
        img {
